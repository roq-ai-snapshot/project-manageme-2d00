...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Project #67890.update': { roles: ['tenant-roles'], key: 'project', tenantPath: [], userPath: [] },
  'Task #24680.update': { roles: ['tenant-roles'], key: 'task', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'project-manager', 'team-member', 'stakeholder', 'client'];

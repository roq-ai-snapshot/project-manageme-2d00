...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTasks({
        relations: ['project', 'user_task.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('project', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('user_task', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_task',
          header: 'User Task',
          accessorKey: 'user_task',
          cell: ({ row: { original: record } }: any) => record?._count?.user_task,
        }
      : null,

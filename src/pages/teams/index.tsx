...
export function TeamListPage(props: TeamListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTeams({
        relations: ['company', 'user_team.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('user_team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_team',
          header: 'User Team',
          accessorKey: 'user_team',
          cell: ({ row: { original: record } }: any) => record?._count?.user_team,
        }
      : null,
